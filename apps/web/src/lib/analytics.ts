...
export const AnalyticsEvent = {
  ...
  BuildBookmarked: "build_bookmarked",
  BuildShareOpened: "build_share_opened",
  BuildRated: "build_rated",
  BuildAutoPublished: "build_auto_published",
  BuildPublished: "build_published",
  BuildRenamed: "build_renamed",
  BuildRerolled: "build_rerolled",
