...
const INTENTS = [
  ...
  { id: "something_new", label: "Something new", hint: "Break prior patterns for a fresh run.", icon: wowPackUrl("Miscellaneous", "QuestionMark.png") },
  ...
  { id: "just_fun", label: "Just fun", hint: "Style-first recommendation with HC guardrails.", icon: wowPackUrl("Miscellaneous", "Dice_01.png") },
] as const;
