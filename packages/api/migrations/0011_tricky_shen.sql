...
CREATE INDEX `idx_ai_fragment_cache_last_used` ON `ai_fragment_cache` (`last_used_at`);--> statement-breakpoint
...
CREATE INDEX `idx_build_commit_feedback_commit_session` ON `build_commit_feedback` (`build_commit_id`,`session_id`);