...
export const recommendInputSchema = z.object({
  ...
  signals: z.object({
    ...
    preferredClasses: z.array(z.enum(classValues)).max(6).optional(),
    ...
    preferredRaces: z.array(z.string().min(2).max(24)).max(8).optional(),
    excludedRaces: z.array(z.string().min(2).max(24)).max(8).optional(),
