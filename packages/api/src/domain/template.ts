...
export function renderTemplateDestiny(top: RankedArchetype): DestinyOutput {
  ...
  return {
    ...
    raceSuggestion: archetype.raceSuggestion ?? "TBD",
    factionSuggestion: archetype.faction === "either" ? "neutral" : archetype.faction,
    genderLean: archetype.genderLean ?? "neutral",
